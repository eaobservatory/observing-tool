...
public class SpIterCGS4CalUnit extends SpIterConfigObs
{
   ...
   public static final SpType SP_TYPE =
        SpType.create(SpType.ITERATOR_COMPONENT_TYPE, "CGS4CalUnit", "CGS4 Cal Unit (Advanced)");
...
getAvailableItems()
{
   ...
   IterConfigItem iciCalType = new IterConfigItem(
	"Cal. Type",
	SpCGS4CalUnitConstants.ATTR_CALTYPE + "Iter",
	calTypes);

   IterConfigItem iciArcLamps = new IterConfigItem(
	"Arc Lamp",
	SpCGS4CalUnitConstants.ATTR_LAMP + "Iter",
	SpIterCGS4CalObs.ARC_LAMPS);
 
   IterConfigItem iciFlatLamps = new IterConfigItem(
	"Flat Lamp",
	SpCGS4CalUnitConstants.ATTR_LAMP + "Iter",
   ...
   IterConfigItem iciModes = new IterConfigItem(
	"Mode",
...
//        "Exp. Time",
//        SpCGS4CalUnitConstants.ATTR_EXPOSURE_TIME + "Iter",
//        null);
// 
//   IterConfigItem iciCoadds = new IterConfigItem(
//        "Coadds",
//        SpCGS4CalUnitConstants.ATTR_COADDS + "Iter",
//        null);
 
   IterConfigItem[] iciA = {
	iciCalType, iciArcLamps, iciFlatLamps, iciFilters, iciModes,
