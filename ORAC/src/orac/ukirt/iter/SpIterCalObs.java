...
getLamp()
{
   ...
   if (lamp == null)  lamp = SpCalUnitConstants.CGS4_ARC_LAMPS[0];
   return lamp;
}
...
{
//   String lamp = getLamp();
//   for (int i=0; i<SpCalUnitConstants.CGS4_FLAT_LAMPS.length; ++i) {
...
getFilter()
{
   ...
   if (filter == null)  filter = SpCalUnitConstants.CGS4_FILTERS[0];
   return filter;
}
...
getMode()
{
   ...
   if (mode == null)  mode = SpCalUnitConstants.MODES[0];
   return mode;
}
