...
public final class SpIterWFS extends SpIterConfigObsUKIRT implements SpTranslatable {
    ...
    public static final SpType SP_TYPE =
        SpType.create(SpType.ITERATOR_COMPONENT_TYPE, "iterWFS", "WFS");
    static {
    ...
    public IterConfigItem[] getAvailableItems() {
        IterConfigItem icilensPos = new IterConfigItem(
                "LensPos", 
                SpInstWFS.ATTR_LENS_POS + "Iter",
                SpInstWFS.LENS_POS);

        IterConfigItem[] iciA = {
            icilensPos, getExposureTimeConfigItem(), getCoaddsConfigItem() 
        };
