...
public final class SpInstIRCAM3 extends SpUKIRTInstObsComp {
   ...
   public static final SpType SP_TYPE =
     SpType.create( SpType.OBSERVATION_COMPONENT_TYPE, "inst.IRCAM3", "IRCAM3" );
...
// Read the X,Y instrument apertures from the readout-area lookup table.
      double x = 
        ( Double.valueOf( (String) READAREAS.elementAt( roai, 1 ) ) ).doubleValue();
      double y = 
        ( Double.valueOf( (String) READAREAS.elementAt( roai, 2 ) ) ).doubleValue();
