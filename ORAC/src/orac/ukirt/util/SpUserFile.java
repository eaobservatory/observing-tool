...
// Use the File.separator method to obtain the directory separator.
      ...
      if ( dirname.endsWith( separator ) ) {
         ...
         userFileDirName = dirname + separator;
      }
...
// ==================
      ...
      Vector userTargetLists;             // List of observation target lists
...
// stores them in a vector.
      targetLists = SpTreeMan.findAllItems( spRootItem, 
                    "gemini.sp.obsComp.SpTelescopeObsComp" ); 
...
// stripped.
         ...
         userFileName = getUserFileDirectory() + getPrefix() +
                        timeTag + ".dat";
...
// present.
                     ...
                     if ( targetName == "" ) { targetName = "unidentified object"; }
...
// keeps the compiler happy.
                     ...
                     if ( baseValues.size() > 9 ) {
                        ...
                        if ( parallax.equals( "" ) ) { parallax = "0.000"; }
                     } else {
                        parallax = "0.000";
                     }
