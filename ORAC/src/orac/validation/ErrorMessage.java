...
public class ErrorMessage {
  ...
  private static Hashtable itemNames = new Hashtable();
  ...
  public void   setParameter(String s) { _parameter = s;    }
  public void   setProblem  (String s) { _problem   = s;    }
  public void   setExpected (String s) { _expected  = s;    }
  public void   setFound    (String s) { _found     = s;    }
  public static void setErrorCount  (int c) { _errorWarningCount[ERROR]   = c; }
  public static void setWarningCount(int c) { _errorWarningCount[WARNING] = c; }
  

  public int    getType     () { return _type;      }
  public String getItem     () { return _item;      }
  public String getParameter() { return _parameter; }
  public String getProblem  () { return _problem;   }
  public String getExpected () { return _expected;  }
  public String getFound    () { return _found;     }
  public static int getErrorCount  () { return _errorWarningCount[ERROR]  ; }
  public static int getWarningCount() { return _errorWarningCount[WARNING]; }
