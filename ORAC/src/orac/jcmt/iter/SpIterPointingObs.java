 ...
 */
class SpIterPointingObsEnumeration extends SpIterEnumeration
{
   private int _curCount = 0;
   private int _maxCount;
   private SpIterValue[] _values;

SpIterPointingObsEnumeration(SpIterPointingObs iterObserve)
{
   super(iterObserve);
...
_thisFirstElement()
{
   SpIterPointingObs ibo   = (SpIterPointingObs) _iterComp;
...
_thisNextElement()
{
   return new SpIterStep("pointing", _curCount++, _iterComp, _values);
}
 ...
 */
public class SpIterPointingObs extends SpIterObserveBase
{
...
elements()
{
   return new SpIterPointingObsEnumeration(this);
}
...
//MFO JCMT//   return spi.getDefaultPointingExpTime();
/*MFO JCMT*/   return 0;
}
...
//MFO JCMT//   return spi.getDefaultPointingCoadds();
/*MFO JCMT*/   return 0;
