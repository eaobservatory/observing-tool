 ...
 */
class SpIterJiggleObsEnumeration extends SpIterEnumeration
{
   private int _curCount = 0;
   private int _maxCount;
   private SpIterValue[] _values;

SpIterJiggleObsEnumeration(SpIterJiggleObs iterObserve)
{
   super(iterObserve);
...
_thisFirstElement()
{
   SpIterJiggleObs ibo   = (SpIterJiggleObs) _iterComp;
...
_thisNextElement()
{
   return new SpIterStep("jiggle", _curCount++, _iterComp, _values);
}
 ...
 * @author modified for JCMT by Martin Folger ( M.Folger@roe.ac.uk )
 */
public class SpIterJiggleObs extends SpIterObserveBase
{
...
elements()
{
   return new SpIterJiggleObsEnumeration(this);
}
...
//MFO JCMT//   return spi.getDefaultJiggleExpTime();
/*MFO JCMT*/   return 0;
}
...
//MFO JCMT//   return spi.getDefaultJiggleCoadds();
/*MFO JCMT*/   return 0;
