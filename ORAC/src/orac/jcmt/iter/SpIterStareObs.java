 ...
 */
class SpIterStareObsEnumeration extends SpIterEnumeration
{
   private int _curCount = 0;
   private int _maxCount;
   private SpIterValue[] _values;

SpIterStareObsEnumeration(SpIterStareObs iterObserve)
{
   super(iterObserve);
...
_thisFirstElement()
{
   SpIterStareObs ibo   = (SpIterStareObs) _iterComp;
...
_thisNextElement()
{
   return new SpIterStep("stare", _curCount++, _iterComp, _values);
}
 ...
 */
public class SpIterStareObs extends SpIterObserveBase
{
...
elements()
{
   return new SpIterStareObsEnumeration(this);
}
...
//MFO JCMT//   return spi.getDefaultStareExpTime();
/*MFO JCMT*/   return 0;
}
...
//MFO JCMT//   return spi.getDefaultStareCoadds();
/*MFO JCMT*/   return 0;
