...
public class TextPrint {
  ...
  public void setPrintJobTitle(String printJobTitle) { _printJobTitle = printJobTitle; }
  public String getPrintJobTitle()                     { return          _printJobTitle; }
 
  public void setFont(Font font) { _font = font; }
  public Font getFont()          { return _font; }
  
  public void setLineSpacing(int lineSpacing) { _lineSpacing = lineSpacing; }
  public int getLineSpacing()                { return        _lineSpacing; }

  public void set_y_offet(int y) { _y_offset = y;    }
  public int get_y_offet()      { return _y_offset; }

  public void set_x_offet(int x) { _x_offset = x;    }
  public int get_x_offet()      { return _x_offset; }
