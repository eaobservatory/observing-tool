...
/**
 * Contains details about errors and warnings that occurred during the
 * validation of a science program or observation.
 *
...
public class ErrorMessage {
    ...
    private static Hashtable<String, String> itemNames =
     ...
     * @param item    Description of item where the invalid value has been
     *                found.
     ...
     */
    public ErrorMessage(int type, String item, String parameter,
     ...
     * @param found     Value actually found.
     */
    public ErrorMessage(int type, SpItem item, String parameter,
            String expected, String found) {
    ...
    private static String getDescription(SpItem item) {
        return itemNames.get(item.typeStr())
                + " (" + item.getTitle()
                + ", " + item.subtypeStr() + ")";
    }
