...
public class MapArea {
    public static final double DAS2R = Math.PI / (180.0 * 3600.0);
    public static final double DD2R = Math.PI / 180.0;
    private static final Pal pal = new Pal();

    public static void main(String[] args) {
        for (RADec value : createNewMapArea(
                96.33727, -60.18855, 0, 0, 180, 180, 0))
            System.out.println(HHMMSS.valStr(value.ra) + " "
                    + DDMMSS.valStr(value.dec));
    }

    /**
     * Returns the four FK5 positions for a map defined in Galactic
     * coordinates.
     *
     * @param longitude
     * @param lattitude
     ...
     */
    public static RADec[] createNewMapArea(double longitude, double lattitude,
        ...
        double mx1 = mapWidth / 2.0;
        double my1 = mapHeight / 2.0;
        double mx2 = mapWidth / 2.0;
        double my2 = -1.0 * mapHeight / 2.0;
        double mx3 = -1.0 * mapWidth / 2.0;
        double my3 = -1.0 * mapHeight / 2.0;
        double mx4 = -1.0 * mapWidth / 2.0;
        double my4 = mapHeight / 2.0;
    ...
    private static RADec Dpt2s(double longitude, double lattitude,
            double baselong, double baselat) {
        ...
        return CoordConvert.gal2fk5(Math.toDegrees(newLong),
                Math.toDegrees(newLatt));
    }
