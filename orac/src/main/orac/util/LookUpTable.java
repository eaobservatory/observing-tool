...
/**
 * This implements a look up table utility class.
 *
 * The table is implemented as a Vector of Vectors. Objects of any type
...
public class LookUpTable extends Vector<String> {
     ...
     */
    public LookUpTable(int numRows, int numColumns)
     ...
     */
    public void setElementAt(String obj, int rowPos, int colPos)
            throws ArrayIndexOutOfBoundsException {
        if (rowPos < 0 || rowPos >= numRows || colPos < 0
                || colPos >= numColumns) {
     ...
     */
    public void setRowAt(Vector<String> row, int rowPos)
            throws ArrayIndexOutOfBoundsException {
    ...
    /**
     * Returns a Vector of the objects in the specified column.
     */
    ...
    /**
     * Returns the Object at the given row/column position.
     */
    public String elementAt(int row, int column)
            throws ArrayIndexOutOfBoundsException {
    ...
    /**
     * Returns the index (position) of a string in the given column.
     */
    public int indexInColumn(String str, int column)
    ...
    /**
     * Returns the index (position) of a string in the given row.
     */
    public int indexInRow(String str, int row)
            throws ArrayIndexOutOfBoundsException, NoSuchElementException {
        if (row < 0 || row >= numRows) {
            throw new ArrayIndexOutOfBoundsException();
        }
    ...
    /**
     * Searches through a row of values and returns the column
     * position for which the row value, interpreted as a double, is the
     * smallest one greater than the argument given
     */
    public int rangeInRow(double dval, int row)
            throws ArrayIndexOutOfBoundsException {
        if (row < 0 || row >= numRows) {
            throw new ArrayIndexOutOfBoundsException();
        }
