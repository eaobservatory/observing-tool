...
public class ReceiverList {
    public static Hashtable<String, Receiver> getReceiverTable() {
        ...
        r.bandspecs.add(new BandSpec("1-system", 1,
                ...
                new int[]{32768, 8192},
                new int[]{4, 4}));
        r.bandspecs.add(new BandSpec("4-system", 4,
                new double[]{0.25E9, 1.0E9},
                new int[]{8192, 2048}));
        r.bandspecs.add(new BandSpec("8-system", 8,
                new double[]{0.25E9, 1.0E9},
                new int[]{4096, 1024}));
