...
/* Create details of all known receivers and record them in the 
   hashtable */
      ...
      r.bandspecs.add ( new BandSpec ( "1-system", 1, new double[] { 0.25E9, 1.0E9 }, new int[] { 8192, 2048 } ) );
      r.bandspecs.add ( new BandSpec ( "2-system", 2, new double[] { 0.25E9, 1.0E9 }, new int[] { 4096, 1024 } ) );
      r.bandspecs.add ( new BandSpec ( "hybrid", 1,   new double[] { 0.5E9,  2.0E9 }, new int[] { 8192, 2048 } ) );
      ...
      r.bandspecs.add ( new BandSpec ( "hybrid", 1,   new double[] { 1.0E9,  4.0E9 }, new int[] { 32768, 8192 } ) );
