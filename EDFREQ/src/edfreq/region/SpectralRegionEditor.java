...
public class SpectralRegionEditor extends JPanel implements ActionListener {
    ...
    public void addBaselineFitRegions( double [] xMin, double [] xMax, double lo1, boolean resetLayout) {
        //       System.out.println("Called addBaselineFitRegions with arguments - ");
    ...
    public void addBaselineFitRegion(double [] xMin, double [] xMax, double lo1, boolean resetLayout) {
        ...
        //     System.out.println("\twidth=" + _lineDisplay.getDisplayWidth());
            ...
            double redshift)
    {
        ...
        //       System.out.println("In SpectralRegionEditor::updateLineDisplay()");
...
//             System.out.println("\tLO1=" + _lineDisplay.getLO1());
...
//             }
    ...
    public double [][] getBaselineFitRegions() {
        ...
        for(int i = 0; i < _fitRegionBars.size(); i++) {
            for ( int n=0; n<((DoubleSideBandRangeBar)_fitRegionBars.get(i)).getNumBars(); n++ ) {
                ...
                if ( ((DoubleSideBandRangeBar)_fitRegionBars.get(i)).hasBaselineChanged() || _baselinesChanged ) {
                    result[k++] = getRegion(barX, barWidth, pixelsPerValue, _lineDisplay.getLO1());
                }
                else {
    ...
    public double [] getRegion(int barX, int barWidth, double pixelsPerValue, double lo1) {
        //     System.out.println("Called SpectralRegionEditor::getRegion(" + barX + ", "
    ...
    public boolean changedBaseline() {
        ...
        if ( !flag ) {
            for ( int i=0; i<_fitRegionBars.size(); i++ ) {
                DoubleSideBandRangeBar bar = (DoubleSideBandRangeBar)_fitRegionBars.get(i);
