...
public class VelocityDisplay extends JPanel {
    ...
    public void updateDisplay() {
        ...
        _targetScale = new GraphScale (loVel, hiVel,
                100.0, 10.0, _redshift, 0, DEFAULT_DISPLAY_WIDTH, JSlider.HORIZONTAL, true);
        _localScale = new GraphScale( loVel, hiVel,
                100.0, 10.0, 0.0, 0, DEFAULT_DISPLAY_WIDTH, JSlider.HORIZONTAL, true);

         _el = new EmissionLines(_lRangeLimit, _uRangeLimit, 0.0, DEFAULT_DISPLAY_WIDTH,
                 20, 1);
