...
public class IterWFCAMCalObsGUI extends JPanel
{
	...
	private void jbInit() throws Exception
	{
		...
		this.add( jLabel1 , new GridBagConstraints( 0 , 0 , 1 , 1 , 0. , 0. , GridBagConstraints.EAST , GridBagConstraints.NONE , new Insets( 0 , 0 , 20 , 0 ) , 0 , 0 ) );
		...
		this.add( jLabel8 , new GridBagConstraints( 0 , 1 , 1 , 1 , 0. , 0. , GridBagConstraints.EAST , GridBagConstraints.NONE , new Insets( 0 , 0 , 10 , 0 ) , 0 , 0 ) );
		...
		this.add( jLabel2 , new GridBagConstraints( 0 , 2 , 1 , 1 , 0. , 0. , GridBagConstraints.EAST , GridBagConstraints.NONE , new Insets( 0 , 30 , 10 , 0 ) , 0 , 0 ) );
		...
		this.add( jLabel3 , new GridBagConstraints( 0 , 4 , 1 , 1 , 0. , 0. , GridBagConstraints.EAST , GridBagConstraints.NONE , new Insets( 20 , 10 , 10 , 0 ) , 0 , 0 ) );
		this.add( ExpTime , new GridBagConstraints( 1 , 4 , 1 , 1 , 0. , 0. , GridBagConstraints.CENTER , GridBagConstraints.HORIZONTAL , new Insets( 20 , 10 , 10 , 10 ) , 70 , 0 ) );
		this.add( jLabel7 , new GridBagConstraints( 2 , 4 , 1 , 1 , 0. , 0. , GridBagConstraints.WEST , GridBagConstraints.NONE , new Insets( 20 , 0 , 0 , 0 ) , 0 , 0 ) );
		this.add( jLabel4 , new GridBagConstraints( 0 , 5 , 1 , 1 , 0. , 0. , GridBagConstraints.EAST , GridBagConstraints.NONE , new Insets( 0 , 30 , 0 , 0 ) , 0 , 0 ) );
		this.add( Coadds , new GridBagConstraints( 1 , 5 , 1 , 1 , 0. , 0. , GridBagConstraints.CENTER , GridBagConstraints.HORIZONTAL , new Insets( 0 , 20 , 10 , 20 ) , 0 , 0 ) );
		this.add( jLabel5 , new GridBagConstraints( 0 , 6 , 1 , 1 , 0. , 0. , GridBagConstraints.EAST , GridBagConstraints.NONE , new Insets( 20 , 0 , 0 , -20 ) , 0 , 0 ) );
		this.add( repeatComboBox , new GridBagConstraints( 1 , 6 , 1 , 1 , 0. , 0. , GridBagConstraints.CENTER , GridBagConstraints.HORIZONTAL , new Insets( 20 , 30 , 0 , 20 ) , 0 , 0 ) );
		this.add( jLabel6 , new GridBagConstraints( 2 , 6 , 1 , 1 , 0. , 0. , GridBagConstraints.WEST , GridBagConstraints.NONE , new Insets( 20 , -10 , 0 , 0 ) , 20 , 0 ) );
		this.add( useDefaults , new GridBagConstraints( 0 , 7 , 4 , 1 , 0. , 0. , GridBagConstraints.CENTER , GridBagConstraints.NONE , new Insets( 20 , 0 , 0 , 0 ) , 60 , 0 ) );
	}
}
