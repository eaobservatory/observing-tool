...
public class IterWFCAMCalObsGUI extends JPanel
{
	...
	private void jbInit() throws Exception
	{
		...
		this.add( typeLabel , new GridBagConstraints( 0 , 0 , 1 , 1 , 0. , 0. , GridBagConstraints.EAST , GridBagConstraints.NONE , new Insets( 0 , 0 , 20 , 0 ) , 0 , 0 ) ) ;
		this.add( CalType , new GridBagConstraints( 1 , 0 , 1 , 1 , 0. , 0. , GridBagConstraints.CENTER , GridBagConstraints.NONE , new Insets( 0 , 0 , 20 , 10 ) , 30 , 0 ) ) ;
		this.add( readModeLabel , new GridBagConstraints( 0 , 1 , 1 , 1 , 0. , 0. , GridBagConstraints.EAST , GridBagConstraints.NONE , new Insets( 0 , 0 , 10 , 0 ) , 0 , 0 ) ) ;
		this.add( ReadMode , new GridBagConstraints( 1 , 1 , 1 , 1 , 0. , 0. , GridBagConstraints.CENTER , GridBagConstraints.HORIZONTAL , new Insets( 0 , 10 , 10 , 0 ) , 60 , 0 ) ) ;
		this.add( filterLabel , new GridBagConstraints( 0 , 2 , 1 , 1 , 0. , 0. , GridBagConstraints.EAST , GridBagConstraints.NONE , new Insets( 0 , 30 , 10 , 0 ) , 0 , 0 ) ) ;
		this.add( Filter , new GridBagConstraints( 1 , 2 , 1 , 1 , 0. , 0. , GridBagConstraints.CENTER , GridBagConstraints.HORIZONTAL , new Insets( 0 , 10 , 10 , 0 ) , 60 , 0 ) ) ;
		this.add( focusLabel , new GridBagConstraints( 0 , 3 , 1 , 1 , 0. , 0. , GridBagConstraints.EAST , GridBagConstraints.NONE , new Insets( 0 , 10 , 10 , 0 ) , 0 , 0 ) ) ;
		this.add( focusPos , new GridBagConstraints( 1 , 3 , 1 , 1 , 0. , 0. , GridBagConstraints.CENTER , GridBagConstraints.HORIZONTAL , new Insets( 0 , 10 , 10 , 10 ) , 70 , 0 ) ) ;
		this.add( focusTelStepsLabel , new GridBagConstraints( 0 , 4 , 1 , 1 , 0. , 0. , GridBagConstraints.EAST , GridBagConstraints.NONE , new Insets( 0 , 10 , 10 , 0 ) , 0 , 0 ) ) ;
		this.add( focusTelSteps , new GridBagConstraints( 1 , 4 , 1 , 1 , 0. , 0. , GridBagConstraints.CENTER , GridBagConstraints.HORIZONTAL , new Insets( 0 , 10 , 10 , 10 ) , 70 , 0 ) ) ;
		this.add( expTimeLabel , new GridBagConstraints( 0 , 5 , 1 , 1 , 0. , 0. , GridBagConstraints.EAST , GridBagConstraints.NONE , new Insets( 20 , 10 , 10 , 0 ) , 0 , 0 ) ) ;
		this.add( ExpTime , new GridBagConstraints( 1 , 5 , 1 , 1 , 0. , 0. , GridBagConstraints.CENTER , GridBagConstraints.HORIZONTAL , new Insets( 20 , 10 , 10 , 10 ) , 70 , 0 ) ) ;
		this.add( secLabel , new GridBagConstraints( 2 , 5 , 1 , 1 , 0. , 0. , GridBagConstraints.WEST , GridBagConstraints.NONE , new Insets( 20 , 0 , 0 , 0 ) , 0 , 0 ) ) ;
		this.add( cooaddsLabel , new GridBagConstraints( 0 , 6 , 1 , 1 , 0. , 0. , GridBagConstraints.EAST , GridBagConstraints.NONE , new Insets( 0 , 30 , 0 , 0 ) , 0 , 0 ) ) ;
		this.add( Coadds , new GridBagConstraints( 1 , 6 , 1 , 1 , 0. , 0. , GridBagConstraints.CENTER , GridBagConstraints.HORIZONTAL , new Insets( 0 , 20 , 10 , 20 ) , 0 , 0 ) ) ;
		this.add( observeLabel , new GridBagConstraints( 0 , 7 , 1 , 1 , 0. , 0. , GridBagConstraints.EAST , GridBagConstraints.NONE , new Insets( 20 , 0 , 0 , -20 ) , 0 , 0 ) ) ;
		this.add( repeatComboBox , new GridBagConstraints( 1 , 7 , 1 , 1 , 0. , 0. , GridBagConstraints.CENTER , GridBagConstraints.HORIZONTAL , new Insets( 20 , 30 , 0 , 20 ) , 0 , 0 ) ) ;
		this.add( XLabel , new GridBagConstraints( 2 , 7 , 1 , 1 , 0. , 0. , GridBagConstraints.WEST , GridBagConstraints.NONE , new Insets( 20 , -10 , 0 , 0 ) , 20 , 0 ) ) ;
		this.add( useDefaults , new GridBagConstraints( 0 , 8 , 4 , 1 , 0. , 0. , GridBagConstraints.CENTER , GridBagConstraints.NONE , new Insets( 20 , 0 , 0 , 0 ) , 60 , 0 ) ) ;
	}
}
