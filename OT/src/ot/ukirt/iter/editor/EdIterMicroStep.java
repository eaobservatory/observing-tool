 ...
 */
public final class EdIterMicroStep extends OtItemEditor
...
private void
_updateSpIterMicroStep(String pattern)
{
   SpIterMicroStep microStepIter = (SpIterMicroStep) _spItem;
   SpInstObsComp inst = microStepIter.getInstrumentItem();
   ...
   if((inst != null) && (inst instanceof SpMicroStepUser) && (!pattern.equals(SpIterMicroStep.NO_PATTERN))) {
      ...
      // The microstep iterator should be used with an instruments classes that implement the SpMicroStepUser
      // interface and provide a list of meaningful instrument specific microstep patterns.
