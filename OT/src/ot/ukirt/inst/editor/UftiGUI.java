...
public class UftiGUI extends JPanel {
  ...
  TextBoxWidgetExt filter = new TextBoxWidgetExt();
    ...
    void jbInit() throws Exception
	{
		...
		this.add( sourceMag , new GridBagConstraints( 0 , 3 , 2 , 1 , 0.0 , 0.0 , GridBagConstraints.WEST , GridBagConstraints.NONE , new Insets( 0 , 0 , 0 , 0 ) , 0 , 0 ) );
		...
		this.add( acqMode , new GridBagConstraints( 0 , 5 , 2 , 1 , 0.0 , 0.0 , GridBagConstraints.WEST , GridBagConstraints.NONE , new Insets( 0 , 0 , 0 , 0 ) , 0 , 0 ) );
		...
		jPanel1.add( jLabel12 , new GridBagConstraints( 0 , 0 , 2 , 1 , 0.0 , 0.0 , GridBagConstraints.WEST , GridBagConstraints.NONE , new Insets( 0 , 0 , 0 , 0 ) , 0 , 0 ) );
		jPanel1.add( jLabel14 , new GridBagConstraints( 0 , 2 , 2 , 1 , 0.0 , 0.0 , GridBagConstraints.WEST , GridBagConstraints.NONE , new Insets( 7 , 0 , 0 , 0 ) , 0 , 5 ) );
		jPanel1.add( filterBroadBand , new GridBagConstraints( 0 , 3 , 2 , 1 , 0.0 , 0.0 , GridBagConstraints.NORTHWEST , GridBagConstraints.NONE , new Insets( 0 , 16 , 0 , 0 ) , 0 , 0 ) );
		jPanel1.add( filterNarrowBand , new GridBagConstraints( 0 , 4 , 2 , 1 , 0.0 , 0.0 , GridBagConstraints.NORTHWEST , GridBagConstraints.NONE , new Insets( 0 , 16 , 0 , 0 ) , 0 , 0 ) );
		jPanel1.add( filterSpecial , new GridBagConstraints( 0 , 5 , 2 , 1 , 0.0 , 0.0 , GridBagConstraints.NORTHWEST , GridBagConstraints.NONE , new Insets( 0 , 16 , 0 , 0 ) , 0 , 0 ) );
		jPanel1.add( jScrollPane1 , new GridBagConstraints( 2 , 0 , 1 , 8 , 1.0 , 1.0 , GridBagConstraints.NORTHEAST , GridBagConstraints.VERTICAL , new Insets( 0 , 0 , 0 , 0 ) , 211 , 0 ) );
		jPanel1.add( jLabel13 , new GridBagConstraints( 0 , 6 , 1 , 1 , 0.0 , 0.0 , GridBagConstraints.NORTHWEST , GridBagConstraints.NONE , new Insets( 0 , 0 , 0 , 0 ) , 0 , 6 ) );
		jPanel1.add( filter , new GridBagConstraints( 0 , 1 , 2 , 1 , 0.0 , 0.0 , GridBagConstraints.CENTER , GridBagConstraints.NONE , new Insets( 0 , 0 , 0 , 0 ) , 68 , 0 ) );
		jPanel1.add( polariser , new GridBagConstraints( 1 , 6 , 1 , 2 , 0.0 , 0.0 , GridBagConstraints.NORTHEAST , GridBagConstraints.NONE , new Insets( -1 , 5 , 1 , 0 ) , 43 , 0 ) );
		this.add( defaultAcquisition , new GridBagConstraints( 3 , 7 , 1 , 1 , 0.0 , 0.0 , GridBagConstraints.CENTER , GridBagConstraints.NONE , new Insets( 0 , 0 , 0 , 0 ) , 0 , 0 ) );
		this.add( scienceFOV , new GridBagConstraints( 0 , 7 , 2 , 1 , 0.0 , 0.0 , GridBagConstraints.WEST , GridBagConstraints.NONE , new Insets( 0 , 0 , 0 , 0 ) , 120 , 5 ) );
		this.add( jLabel11 , new GridBagConstraints( 2 , 7 , 1 , 1 , 0.0 , 0.0 , GridBagConstraints.WEST , GridBagConstraints.NONE , new Insets( 0 , 1 , 0 , 2 ) , 0 , 0 ) );
