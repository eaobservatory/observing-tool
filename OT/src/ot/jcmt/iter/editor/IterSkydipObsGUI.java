...
public class IterSkydipObsGUI extends JPanel {
  ...
  JComboBox startPositionComboBox = new JComboBox();
...
//    jComboBox1.addItem("stare");
    ...
    jLabel2.setBounds(new Rectangle(5, 107, 149, 17));
    jComboBox2.setBounds(new Rectangle(160, 103, 123, 26));
    ...
    switchingModePanel.setBounds(new Rectangle(163, 139, 217, 121));
    ...
    jLabel11.setBounds(new Rectangle(143, 29, 68, 17));
    jLabel12.setText("System");
    jLabel12.setBounds(new Rectangle(14, 80, 64, 17));
    jLabel13.setText("y");
    jLabel13.setBounds(new Rectangle(15, 55, 51, 17));
    jLabel14.setText("x");
    jLabel14.setBounds(new Rectangle(15, 28, 59, 17));
    ...
    jLabel26.setBounds(new Rectangle(124, 29, 86, 18));
    ...
    jTextField25.setText("10");
    jTextField25.setBounds(new Rectangle(161, 12, 121, 21));
    jLabel37.setText("Start Position");
    jLabel37.setBounds(new Rectangle(6, 52, 147, 17));
    jLabel36.setText("No of Positions");
    jLabel36.setBounds(new Rectangle(5, 11, 146, 17));
    startPositionComboBox.setBounds(new Rectangle(160, 47, 123, 26));
    jComboBox4.addItem("FK4 (B1950)");
    jComboBox4.addItem("FK5 (J2000)");
    jComboBox4.addItem("AZEL");
    repeatPanel.setBounds(new Rectangle(6, 212, 146, 44));
    ...
    jLabel19.setText("X");
    this.add(jLabel37, null);
    this.add(jLabel36, null);
    this.add(jLabel2, null);
    this.add(jComboBox2, null);
    this.add(startPositionComboBox, null);
    ...
    startPositionComboBox.addItem("Zenith");
    startPositionComboBox.addItem("Horizon");
    startPositionComboBox.addItem("Automatic");
  }
