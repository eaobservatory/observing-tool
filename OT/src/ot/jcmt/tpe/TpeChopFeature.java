...
/**
 * Draws the range of the Chop on JCMT.
 *
 * This is just a modofied copy of TpeXheadFeature which will need proper implementation
 * for JCMT Chop.
 */
...
{
   super("Chop", "Range of the Chop movement.");
}
...
draw(Graphics g, FitsImageInfo fii)
{
   ...
   g.drawString("Just a test!", _xheadi.x, _xheadi.y);
}
