...
public class TpeReferencePosFeature extends TpePositionFeature
    ...
    static {
	// Initialize the properties supported by the TpeReferencePosFeature.
     ...
     */
    public TpeReferencePosFeature() {
	super("RefInConst", "Location of the reference position.");
    }
...
//	    pm.setFindGuideStars(false);
	...
	return new String[] { OtCfg.telescopeUtil.getAdditionalTarget() };
    }
	...
	*/
	...
	String referenceTag = OtCfg.telescopeUtil.getAdditionalTarget();
	pme = pm.getPositionMapEntry(referenceTag);
