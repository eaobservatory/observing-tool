...
public class ItemEditorGUI extends JPanel {
	...
	Border b = BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5), 
						      BorderFactory.createEtchedBorder());
	_border = (TitledBorder)BorderFactory.createTitledBorder(b, 
								 "Component Editor",
								 TitledBorder.LEFT,
								 TitledBorder.CENTER,
