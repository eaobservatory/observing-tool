...
public void
writeParagraph(String paragraph)
   throws IOException
{
   write("<p>");
   writeLine(paragraph);
...
public void
writeHeader(String text, int size)
   throws IOException
{
...
public void
writeHeaderRefTarget(String anchor, String text, int size)
   throws IOException
{
   write("<h" + size + ">");
...
public void
writeRefSource(String anchor, String text)
   throws IOException
{
...
public void
writeRefTarget(String anchor, String text)
   throws IOException
{
