 ...
 */
public SkycatCfgEntry(
   String type, String longName, String shortName, String url, String symbol)
{
   if ((type      == null) || (longName == null) ||
       (shortName == null) || (url      == null)) {
      throw new IllegalArgumentException(
        "Cannot construct SkycatCfgEntry with null arguments.");
   }
...
equals(Object obj)
{
   ...
   if (!_longName.equals(sce.getLongName())) {
      return false;
   }
   if (!_shortName.equals(sce.getShortName())) {
      return false;
   }
   if (!_urlString.equals(sce.getURLString())) {
      return false;
   }

   String sym = sce.getSymbol();
   return (_symbol == null) ? (sym == null) :
                             ((sym == null) ? false : _symbol.equals(sym));
}
...
toString()
{
   return getClass().getName() + "[" + _servType + ", " + _longName + ", " +
      _shortName + ", " + _urlString + ", " + _symbol + "]";
}
