...
almostZeroDegrees(double angle)
{
 ...
 */
public static boolean
almostZeroRadians(double angle)
{
   if ((angle >= -_ERROR) && (angle <= _ERROR)) {
      return true;
   }
