...
public abstract class TelescopePosList
{
   ...
   getPositionIndex(TelescopePos tp)
   {
      int res = -1;
      int sz  = size();
      for (int i=0; i<sz; ++i) {
    ...
    */
   public void
   setSelectedPos(TelescopePos tp)
   {
      synchronized (this) {
         if (!exists(tp.getTag())) return;
         _selPos = tp;
      }
      _notifyOfSelect(tp);
   }
   ...
   addWatcher(TelescopePosListWatcher tplw)
   {
      if (_watchers == null) {
    ...
    */
   public synchronized void
   deleteWatcher(TelescopePosListWatcher tplw)
   {
    ...
    */
   public synchronized void
   addSelWatcher(TelescopePosSelWatcher tpsw)
   {
    ...
    */
   public synchronized void
   deleteSelWatcher(TelescopePosSelWatcher tpsw)
   {
      if (_selWatchers == null) return;
   ...
   _getSelWatchers()
   {
      if (_selWatchers == null) return null;
    ...
    */
   protected void
   _notifyOfReorder(TelescopePos tp)
   {
      Vector v = _getWatchers();
      if (v == null) return;
      for (int i=0; i<v.size(); ++i) {
    ...
    */
   protected void
   _notifyOfRemove(TelescopePos tp)
   {
      Vector v = _getWatchers();
      if (v == null) return;
      for (int i=0; i<v.size(); ++i) {
    ...
    */
   protected void
   _notifyOfSelect(TelescopePos tp)
   {
