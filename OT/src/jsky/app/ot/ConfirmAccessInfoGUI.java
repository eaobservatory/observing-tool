...
public class ConfirmAccessInfoGUI extends JPanel {
    ...
    void jbInit() throws Exception {
        ...
        loginPage.add(activeOption, new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0
            ,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 1));
        loginPage.add(jLabel3, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0
            ,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 20, 5), 0, 0));
        loginPage.add(keyTextBox, new GridBagConstraints(1, 2, 1, 1, 1.0, 0.0
            ,GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(5, 5, 20, 5), 0, 0));
