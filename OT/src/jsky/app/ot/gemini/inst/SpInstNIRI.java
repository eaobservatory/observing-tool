 ...
 * The NIRI instrument.
 */
public final class SpInstNIRI extends SpInstObsComp
                           implements SpInstNIRIConstants
{
...
{
   switch (mode) {
      case CAMERA_F6:  { return new double[] {123.0, 123.0}; }
      case CAMERA_F14: { return new double[] { 51.0,  51.0}; }
      case CAMERA_F32: { return new double[] { 20.0,  20.0}; }
   }
   return null;
}
