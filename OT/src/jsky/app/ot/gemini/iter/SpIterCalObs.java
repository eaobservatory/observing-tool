...
public class SpIterCalObs extends SpIterObserveBase
{
   ...
   public static final SpType SP_TYPE =
        SpType.create(SpType.ITERATOR_COMPONENT_TYPE, "calUnitObs", "Cal Unit Observe");
...
getLamp()
{
   ...
   if (lamp == null)  lamp = SpCalUnitConstants.LAMPS[0];
   return lamp;
}
...
getFilter()
{
   ...
   if (filter == null)  filter = SpCalUnitConstants.FILTERS[0];
   return filter;
}
...
getDiffuser()
{
   ...
   if (diffuser == null)  diffuser = SpCalUnitConstants.DIFFUSERS[0];
   return diffuser;
}
