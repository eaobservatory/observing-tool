 ...
 */
public final class EdCompInstUFTI extends EdCompInstBase implements
        TableWidgetWatcher, ActionListener {
     ...
     * actionPerformed() to do react to action events caused by initializing
     * widgets.
     */
    ...
    public EdCompInstUFTI() {
        ...
        // MFO: Watcher is now added here rather than in
        // _edStareCapability._init
        _w.coadds.addWatcher(new TextBoxWidgetWatcher() {
    ...
    protected void _updateWidgets() {
        ...
        // Reset _ignoreActionEvents to true after it has been set to false
        // at the end of _updateScienceFOV()
        _ignoreActionEvents = true;
    ...
    private void _updateExpWidgets(boolean setText) {
        ...
        if (setText) {
            ...
            tbw.setText(e);
            validExposureTime = checkExposureTimes(
                    _instUFTI.getExposureTimeAsString());
        }
    ...
    /**
     * The given filter list was selected.
     *
     * Show it, and if the current filter is in the list, highlight it.
     */
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        if (w == _w.acqMode) {
            ...
            validExposureTime = checkExposureTimes(_instUFTI
        ...
        if (candidate.matches("\\d*\\.?\\d*") && !candidate.equals("")) {
            ...
            if (found) {
                ...
                if (minExposure <= candidateDouble
                        && candidateDouble <= maxExposure) {
                    // the following setExpTime is redundant BUT may come
                    // in useful later
