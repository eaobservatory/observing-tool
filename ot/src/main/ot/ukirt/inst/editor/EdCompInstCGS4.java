...
public final class EdCompInstCGS4 extends EdCompInstBase {
    ...
    private void _updateFilter() {
        // The FreeBongo OT (OT2) seems to have an invisible filter text box
        // widget which is never really used but nevertheless updated (?)
        // This Swing OT (OT3) does not have such a  filter text box widget.
        // But _instCGS4 has a filter attribute that has to be set to a
        // default filter when _updateFilter is called.
