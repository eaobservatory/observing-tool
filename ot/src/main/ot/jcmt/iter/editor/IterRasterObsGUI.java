...
public class IterRasterObsGUI extends IterJCMTGenericGUI {
    ...
    private JLabel dimensionWarningTop = GuiUtil.createLabel(
            "Dimension must be equally", Color.red);
    private JLabel dimensionWarningBottom = GuiUtil.createLabel(
            "divisible by spacing", Color.red);
    ...
    public DropDownListBoxWidgetExt scanningStrategies =
    ...
    private void jbInit() throws Exception {
        ...
        Border titleBorder =
                BorderFactory.createTitledBorder(bevelBorder, "Scan setup");
        ...
        areaPanel.setBorder(new TitledBorder(BorderFactory.createLineBorder(
                new Color(153, 153, 153), 2), "Area"));

        // fill in the contents of the area panel
        // width
        areaPanel.add(GuiUtil.createLabel("Width"), new GridBagConstraints(
                0, 0, 2, 1, 0.0, 0.0,
                GBWEST, GBNONE,
                insetsL(5), 0, 0));
        areaPanel.add(width, new GridBagConstraints(
                2, 0, 1, 1, 0.0, 0.0,
                GBCENTER, GBHORIZONTAL,
                allInsets(2), 0, 0));
        areaPanel.add(GuiUtil.createLabel("(arcsecs)"), new GridBagConstraints(
                3, 0, 1, 1, 0.0, 0.0,
                GBEAST, GBNONE,
                allInsets(0), 0, 0));

        // height
        areaPanel.add(GuiUtil.createLabel("Height"), new GridBagConstraints(
                0, 1, 2, 1, 0.0, 0.0,
                GBWEST, GBNONE,
                insetsL(5), 0, 0));
        areaPanel.add(height, new GridBagConstraints(
                2, 1, 1, 1, 0.0, 0.0,
                GBCENTER, GBHORIZONTAL,
                allInsets(2), 0, 0));
        areaPanel.add(GuiUtil.createLabel("(arcsecs)"), new GridBagConstraints(
        ...
        areaPanel.add(GuiUtil.createLabel("PA"), new GridBagConstraints(
                0, 3, 2, 1, 0.0, 0.0,
                GBWEST, GBNONE,
                insetsL(5), 0, 0));
        areaPanel.add(posAngle, new GridBagConstraints(
                2, 3, 1, 1, 0.0, 0.0,
                GBCENTER, GBHORIZONTAL,
                allInsets(2), 0, 0));
        areaPanel.add(GuiUtil.createLabel("(degrees)"), new GridBagConstraints(
                3, 3, 1, 1, 0.0, 0.0,
                GBEAST, GBNONE,
                allInsets(0), 0, 0));

        // dx
        areaPanel.add(GuiUtil.createLabel("Sample Spacing"),
                new GridBagConstraints(
                        0, 5, 2, 1, 0.0, 0.0,
                        GBWEST, GBHORIZONTAL,
                        insetsTL(10, 5), 0, 0));
        areaPanel.add(dx, new GridBagConstraints(
                2, 5, 1, 1, 1.0, 0.0,
                GBCENTER, GBHORIZONTAL,
                allInsets(2), 0, 0));
        areaPanel.add(GuiUtil.createLabel("(arcsecs)"), new GridBagConstraints(
        ...
        areaPanel.add(subAreaPanel, new GridBagConstraints(
                0, 6, 4, 1, 0.0, 0.0,
                GBCENTER, GBHORIZONTAL,
                insetsTL(10, 5), 0, 0));
        ...
        scanPanel.setBorder(new TitledBorder(BorderFactory.createLineBorder(
                new Color(153, 153, 153), 2), "Scan"));

        scanPanel.add(GuiUtil.createLabel("System"), new GridBagConstraints(
                0, 1, 1, 1, 0.0, 0.0, 
                GBWEST, GBNONE,
                insetsL(5), 0, 0));
        scanPanel.add(scanSystem, new GridBagConstraints(
                1, 1, 2, 1, 0.0, 0.0,
                GBSOUTHWEST, GBNONE,
                insetsL(2), 0, 0));
        scanPanel.add(GuiUtil.createLabel("PA"), new GridBagConstraints(
                0, 0, 1, 1, 0.0, 1.0,
                GBWEST, GBNONE,
                insetsLB(5, 5), 0, 0));
        scanPanel.add(scanAngle, new GridBagConstraints(
                1, 0, 1, 1, 0.0, 0.0,
                GBSOUTH, GBHORIZONTAL,
                allInsets(2), 0, 0));
        scanPanel.add(GuiUtil.createLabel("(degrees)"), new GridBagConstraints(
                2, 0, 1, 1, 0.0, 0.0,
                GBEAST, GBNONE,
                allInsets(0), 0, 0));
        ...
        // Heterodyne
        heterodynePanel.setBorder(new TitledBorder(
                BorderFactory.createLineBorder(new Color(153, 153, 153), 2),
                "Heterodyne Details"));
        heterodynePanel.setLayout(new GridBagLayout());
        heterodynePanel.add(GuiUtil.createLabel("Sample Time"),
                new GridBagConstraints(
                        0, 4, 1, 1, 0.0, 0.0,
                        GBWEST, GBNONE,
                        insetsL(5), 0, 0));
        heterodynePanel.add(acsisSampleTime, new GridBagConstraints(
                1, 4, 1, 1, 0.0, 0.0,
                GBCENTER, GBHORIZONTAL,
                allInsets(5), 0, 0));
        heterodynePanel.add(GuiUtil.createLabel("(sec)"),
                new GridBagConstraints(
                        2, 4, 1, 1, 0.0, 0.0,
                        GBCENTER, GBNONE,
                        insetsR(5), 0, 0));
        defaultButton.setText("Default");
        heterodynePanel.add(defaultButton, new GridBagConstraints(
                1, 5, 2, 1, 0.0, 0.0,
                GBWEST, GBNONE,
                allInsets(5), 0, 0));
        heterodynePanel.add(GuiUtil.createLabel("Secs/Row"),
                new GridBagConstraints(
                        0, 6, 1, 1, 0.0, 0.0,
                        GBWEST, GBNONE,
                        insetsL(5), 0, 0));
        heterodynePanel.add(GuiUtil.createLabel("(estimated)"),
                new GridBagConstraints(
                        0, 7, 1, 1, 0.0, 0.0,
                        GBWEST, GBNONE,
                        insetsL(5), 0, 0));
        heterodynePanel.add(GuiUtil.createLabel("Secs/Observation"),
                new GridBagConstraints(
                        0, 9, 1, 1, 0.0, 0.0,
                        GBWEST, GBNONE,
                        insetsL(5), 0, 0));
        heterodynePanel.add(secsPerRow, new GridBagConstraints(
                1, 6, 1, 1, 0.0, 0.0,
                GBCENTER, GBHORIZONTAL,
                allInsets(5), 0, 0));
        heterodynePanel.add(secsPerObservation, new GridBagConstraints(
                1, 9, 2, 1, 0.0, 0.0,
                GBCENTER, GBHORIZONTAL,
                allInsets(5), 0, 0));
        ...
        nonHarpPanel.add(GuiUtil.createLabel(" "), new GridBagConstraints(
                0, 0, 3, 1, 0.0, 0.0,
                GBCENTER, GBBOTH,
                allInsets(0), 0, 0));
        nonHarpPanel.add(GuiUtil.createLabel("Nr of samples/pixels"),
                new GridBagConstraints(
                        0, 1, 2, 1, 0.0, 0.0,
                        GBCENTER, GBBOTH,
                        allInsets(0), 0, 0));
        nonHarpPanel.add(sizeOfXPixel, new GridBagConstraints(
                1, 2, 1, 1, 0.0, 0.0,
                GBCENTER, GBBOTH,
                allInsets(0), 0, 0));
        nonHarpPanel.add(GuiUtil.createLabel("Nr of scans/pixels"),
                new GridBagConstraints(
                        0, 3, 2, 1, 0.0, 0.0,
                        GBCENTER, GBBOTH,
                        allInsets(0), 0, 0));
        nonHarpPanel.add(sizeOfYPixel, new GridBagConstraints(
                1, 4, 1, 1, 0.0, 0.0,
                GBCENTER, GBBOTH,
                allInsets(0), 0, 0));
        nonHarpPanel.add(dimensionWarningTop, new GridBagConstraints(
                0, 5, 3, 1, 0.0, 0.0,
                GBCENTER, GBNONE,
                allInsets(0), 0, 0));
        nonHarpPanel.add(dimensionWarningBottom, new GridBagConstraints(
                0, 6, 3, 1, 0.0, 0.0,
                GBCENTER, GBNONE,
                allInsets(0), 0, 0));
        ...
        harpPanel.add(GuiUtil.createLabel("Scan Spacing"),
                new GridBagConstraints(
                        0, 3, 2, 1, 0.0, 0.0,
                        GBWEST, GBNONE,
                        insetsL(5), 0, 0));
        harpPanel.add(harpRasters, new GridBagConstraints(
                2, 3, 2, 1, 0.0, 0.0,
                GBEAST, GBHORIZONTAL,
                insetsL(5), 0, 0));

        // scuba2
        scuba2Panel.setBorder(new TitledBorder(BorderFactory.createLineBorder(
                new Color(153, 153, 153), 2), "SCUBA-2 Details"));
    ...
    public void addHarpPanel() {
        ...
        areaPanel.add(harpPanel, new GridBagConstraints(
                0, 7, 3, 1, 0.0, 0.0,
                GBCENTER, GBNONE,
                allInsets(0), 0, 0));

        heterodynePanel.add(scanStrategyLabel, new GridBagConstraints(
                0, 2, 1, 1, 0.0, 0.0,
                GBWEST, GBNONE,
                insetsL(5), 0, 0));
        heterodynePanel.add(scanningStrategies, new GridBagConstraints(
                1, 2, 1, 1, 0.0, 0.0,
                GBWEST, GBNONE,
                insetsL(5), 0, 0));
    ...
    public void addNonHarpPanel() {
        ...
        areaPanel.add(nonHarpPanel, new GridBagConstraints(
                0, 7, 3, 1, 0.0, 0.0,
                GBCENTER, GBNONE,
                allInsets(0), 0, 0));
