...
public class MiniConfigIterGUI extends jsky.app.ot.editor.MiniConfigIterGUI {
    ...
    void jbInit() throws Exception {
        ...
        this.add(continuousSpinLabel, new GridBagConstraints(
                1, 10, 1, 1, 1.0, 1.0,
                GridBagConstraints.WEST, GridBagConstraints.NONE,
                new Insets(1, 1, 1, 1), 0, 0));
        this.add(continuousSpinCheckBox, new GridBagConstraints(
                0, 10, 1, 1, 1.0, 1.0,
        ...
        this.add(calibratorInBeamLabel, new GridBagConstraints(
                1, 11, 1, 1, 1.0, 1.0,
                GridBagConstraints.WEST, GridBagConstraints.NONE,
                new Insets(1, 1, 1, 1), 0, 0));
        this.add(calibratorInBeamCheckBox, new GridBagConstraints(
                0, 11, 1, 1, 1.0, 1.0,
                GridBagConstraints.EAST, GridBagConstraints.NONE,
                new Insets(1, 1, 1, 1), 0, 0));
    }
