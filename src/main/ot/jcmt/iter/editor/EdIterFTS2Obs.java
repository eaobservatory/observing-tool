...
public final class EdIterFTS2Obs extends OtItemEditor implements
    ...
    public EdIterFTS2Obs() {
        ...
        _w.scanSpeedNyquist.setMajorTickSpacing(
                SpIterFTS2Obs.speedIncrementScaled);
    ...
    protected void _updateWidgets() {
        ...
        boolean isPort8D = SpIterFTS2Obs.PORT_8D.equals(
                _inst.getTrackingPort());
        ...
        _w.resolutionFOV.setValue((int)
                (resolution * SpIterFTS2Obs.resolutionScale));
        ...
        _w.resolutionMHz.setText(
                "" + MathUtil.round(_inst.getResolutionInMHz(), 4));
