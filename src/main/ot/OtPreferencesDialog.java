...
public class OtPreferencesDialog implements ActionListener {
    /**
     * This is a subclass of JPanel so it can be used for internal as well
     * as other frames.
     */
    ...
    /**
     * The standard actionPerformed method to handle the "ok", "apply",
     * and "cancel" buttons.
     */
        ...
        if (s != null && s.length() != 0) {
            try {
                ...
                JOptionPane.showMessageDialog(null,
                        ...
                        "InvalidPort", JOptionPane.WARNING_MESSAGE);
                port = 80;
            }
