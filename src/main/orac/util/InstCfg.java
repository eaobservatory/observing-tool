...
public class InstCfg {
    ...
    public static boolean likeAttr(InstCfg info, String attr) {
        return (info.getKeyword().toLowerCase().indexOf(attr.toLowerCase())
                == -1) ? false : true;
    }
     ...
     * "value string".
     *
     * The value string may be a single value or arrays.
     */
    ...
    public LookUpTable getValueAsLUT() {
        ...
        // Try to tokenize with "{" or "}" as delimiters.
        // This should give us the "rows".
        StringTokenizer st = new StringTokenizer(value, "{}");
