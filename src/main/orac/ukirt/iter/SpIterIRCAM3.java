...
public class SpIterIRCAM3 extends SpIterConfigObsUKIRT {
    public static final SpType SP_TYPE = SpType.create(
            SpType.ITERATOR_COMPONENT_TYPE, "instIRCAM3", "IRCAM3");
     ...
     * instrument aperture information when it changes.
     *
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            System.out.println("in SpIterIRCAM3: "
    ...
    public IterConfigItem[] getAvailableItems() {
        ...
        IterConfigItem iciAcqMode = new IterConfigItem("Acqmode",
                SpInstIRCAM3.ATTR_MODE + "Iter", SpInstIRCAM3.MODES);
        ...
        IterConfigItem iciReadoutArea = new IterConfigItem("ReadoutArea",
                SpInstIRCAM3.ATTR_READAREA + "Iter", readoutAreas);
        ...
        IterConfigItem iciFilter = new IterConfigItem("Filter",
                SpInstIRCAM3.ATTR_FILTER + "Iter", filters);
