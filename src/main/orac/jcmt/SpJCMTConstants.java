...
public interface SpJCMTConstants {
    ...
    // Generic JCMT iterator. Many of the attribute are actually only used
    // for the Heterodyne instrument.
    ...
    public static final String ATTR_REFERENCE_OFFSET_SYSTEM =
            "referenceOffset.system";

    /** Frequency offset, throw. */
    public static final String ATTR_FREQUENCY_OFFSET_THROW =
            "frequencyOffset.throw";

    /** Frequency offset, rate. */
    public static final String ATTR_FREQUENCY_OFFSET_RATE =
    ...
    public static final String ATTR_SCANAREA_SCAN_VELOCITY =
            "SCAN_AREA.SCAN:VELOCITY";
    public static final String ATTR_SCANAREA_SCAN_SYSTEM =
            "SCAN_AREA.SCAN:SYSTEM";
    public static final String ATTR_SCANAREA_SCAN_DY = "SCAN_AREA.SCAN:DY";
    public static final String ATTR_SCANAREA_SCAN_REVERSAL =
            "SCAN_AREA.SCAN:REVERSAL";
    public static final String ATTR_SCANAREA_SCAN_TIMESTEP =
            "SCAN_AREA.SCAN:TIME_STEP";
    ...
    public static final String[] SCAN_SYSTEMS = {
            TRACKING,
            AZEL,
            MOUNT,
            FPLANE,
     ...
     * </pre>
     */
    public static final String[] CHOP_SYSTEMS = {
            TRACKING,
            AZEL,
            MOUNT,
            FPLANE,
     ...
     * </pre>
     */
    public static final String[] JIGGLE_SYSTEMS = {
            TRACKING,
            AZEL,
            MOUNT,
            FPLANE,
    ...
    public static final String ATTR_SAMPLES_PER_REVOLUTION =
    ...
    // SdW - 01/10/03
    public static final String ATTR_POINTING_METHOD = "pointingMethod";
    ...
    public static final String[] HETERODYNE_NOISE_SOURCES = {
            REFLECTOR,
            SKY,
            ZENITH,
            ECCOSORB,
    ...
    public static final String[] SCUBA2_NOISE_SOURCES = {
            DARK,
            SKY,
            ZENITH,
            BLACKBODY
     ...
     * Flat sources
     */
    public static final String[] SCUBA2_FLAT_SOURCES = {
            DARK,
            SKY,
            ZENITH,
            BLACKBODY,
    ...
    /** SCUBA-2 */
    public static final double SCUBA2_STARTUP_TIME = 20.0;
}
