...
/**
 * Write a Science Program/Plan to a given OutputStream in the Science Program
 * SGML format. See SpInputSGML for the grammar that describes the possible
 * outputs of this class.
 * 
 * <p>
 * <em>Note</em>, this class has been left public, but it is anticipated that
 * clients will primarily be interested in the <code>printDocument()</code>
 * method of SpRootItem. That method creates and uses this class to print a
 * science program document describing the item.
 * 
...
public final class SpOutputSGML
{
     ...
     * Print an item.
     */
	public void printItem( SpItem spItem , String tag , String indent )
	{
	...
	//
	private String _quoteValue( String s , char[] ca )
	{
		int caLen = ca.length;
     ...
     */
	public void printAttributes( SpItem spItem , String indent )
	{
     ...
     */
	public void printChildren( Enumeration children , String indent )
	{
     ...
     *            The item to print
     * @param indent
     *            A string, presumably containing whitespace, to print in front
     *            of each item.
     */
	public void print( SpItem spItem , String indent )
	{

		// For now the tag is the same as the "type" attribute (i.e., its the two letter type code).
     ...
     * Write the given item, presumably a Science Program root.
     */
	public void print( SpItem spItem )
	{
		print( spItem , "" );
	}
     ...
     */
	public void printDocument( SpRootItem spRootItem )
	{
