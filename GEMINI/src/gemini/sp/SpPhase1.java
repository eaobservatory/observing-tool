...
/**
 * The Phase 1 Proposal program item.  This item contains attributes for
 * the fields of a phase 1 proposal definition (and any observations or
 * other items specified during the phase 1 document preparation).
 */
