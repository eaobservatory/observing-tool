 ...
 * notified of structure changes to the program or plan.  Structure changes
 * occur when items are added, removed, or moved.
 *
 * @see SpEditState
 */
public interface SpHierarchyChangeObserver
{
    ...
    */
   public void
   spItemsAdded(SpItem parent, SpItem[] children, SpItem afterChild);

   /**
    * Notification that items have been removed from a node in the program.
    */
   public void
   spItemsRemoved(SpItem parent, SpItem[] children);
    ...
    */
   public void
   spItemsMoved(SpItem oldParent, SpItem[] children,
