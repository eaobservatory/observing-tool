...
*/
	    ...
	    spTelescopeObsComp.getPosList().getBasePosition().setXYFromString(x, y);
            ...
            if(tileString != null) {
              ...
              try {
                ...
                System.err.println("SpSurveyObsComp.load(): Could not parse position in tile from \"" +
   ...
   * format read by the load method of this SpSurveyObsComp class.
...
//    }
   ...
   *
   * Since the SpAvTable of this SpSurveyObsComp is used by which ever SpTelescopeObsComp
