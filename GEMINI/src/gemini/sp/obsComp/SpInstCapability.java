...
/**
 * A base class for instrument capabilities.  A "capability" is a class
 * that simplifies attribute/value manipulation for an instrument.  For
 * instance, the "chop" capability contains methods to get and set number
 * of exposures per chop position, etc.  These methods read and set an
 * associated attribute/value table and serve as a convenience and
 * type-safe way of manipulating these attributes.
 *
 * <p>The base class mainly implements the code required to copy a
 * capability.
 */
