...
/**
 * This is a data object that describes a server definition in a Skycat config
 * file.
 */
public class SkycatServer
{
	...
	/**
     * The server type. For instance, catalog server or image server. Note the
     * variable name uses the convention in skycat.cfg.
     */
	public String serv_type ;

	/**
     * The long name. This is used in menus to identify the server. Note the
     * variable name uses the convention in skycat.cfg.
     */
	public String long_name ;

	/**
     * The short name. Note the variable name uses the convention in skycat.cfg.
     */
	public String short_name ;

	/**
     * The url. This is parsed to contact the server with the appropriate query
     * string.
     */
	public String url ;
	...
	{
		return getClass().getName() + "[" + serv_type + ", " + long_name + ", " + short_name + ", " + url + "]" ;
	}
}
