...
public class LinkedList
{
	...
	/**
     * @return true iff the cursor is not at the end of the list
     */
     ...
     * 
     * @return the current element (before advancing the position)
...
/**
 * A class for enumerating a linked list implements the Enumeration interface.
 */
class ListEnumeration implements java.util.Enumeration
{
	...
	/**
     * @return true iff the iterator is not at the end of the list
     */
	public boolean hasMoreElements()
	{
		return cursor != null ;
