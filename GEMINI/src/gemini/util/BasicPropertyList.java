...
public class BasicPropertyList
{
	...
	/**
     * Add a property watchers. Watchers are notified when a property changes
     * value.
     */
	...
	/**
     * Get the generic (Object) value associated with the named property. This
     * will have to be casted to the proper type.
     */
	...
	/**
     * Get a boolean property by the given name, defaulting to <tt>def</tt> if
     * the property doesn't exist or isn't a boolean.
     */
	...
	/**
     * Set a boolean property with the given name and value. This method will
     * create and add the property if it doesn't exist. If it does exist and is
     * a boolean it will change the value to the argument <tt>value</tt>. If
     * the property exists and isn't a boolean, it will become a boolean and the
	...
	/**
     * Get the value of the "choice" property with the given name, defaulting to
     * <code>def</def>.
	 *
	 * @see ChoiceProperty
	...
	/**
     * Set or initialize a "choice" property of the given name. If the property
     * does not exist, it will be created. If it does exist, the
     * <code>options</code> array will be ignored.
     * 
     * @param name
     *            The name of the choice property.
     * @param options
	...
	/**
     * Set an existing "choice" property to the given value, the index of the
     * desired option.
     * 
     * @see ChoiceProperty
     */
