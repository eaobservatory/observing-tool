...
/**
 * Class used to load an image synchronously.  It should only be used by
 * one client at a time.  Yes, I know about MediaTracker.  But unfortunately
 * it requires an AWT component to work.
 */
...
loadImage(ImageProducer ip)
{
   //System.out.println(getClass().getName() + "loadImage(" + ip + ")");
   _imageFlags = 0;
...
public boolean
imageUpdate(Image im, int flags, int x, int y, int w, int h)
{
