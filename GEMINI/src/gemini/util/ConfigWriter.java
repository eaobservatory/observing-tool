...
public class ConfigWriter {
    ...
    private void writeCGS4( BufferedWriter w, Hashtable t ) throws IOException {
        w.write( formatLegacyConfigTitle( "ASTRONOMICAL", getCurrentName() ) ); w.newLine();
        w.write( " Basic (object) configuration: "); w.newLine();

        String readMode = (String)t.get("readMode");
        if ( readMode.equals("NDSTARE") ) {
            readMode = "ND_STARE";
        }
        w.write( formatLegacyConfig(readMode, "acquisition configuration") ); w.newLine();

        w.write( formatFloatLegacyConfig(t.get("expTime"),  "exposure time") ); w.newLine();
        w.write( formatIntLegacyConfig(t.get("objNumExp"), "exposures/integ") ); w.newLine();
        w.write( formatIntLegacyConfig(t.get("savedInt"), "scans") ); w.newLine();
        ...
        w.write( formatIntLegacyConfig(""+sampling, "sampling") ); w.newLine();
        if ( Integer.parseInt(samplingValues[1]) == 1 ) {
            w.write( formatLegacyConfig( samplingValues[1] + "_pixel", "sample range") ); w.newLine();
        }
        else {
            w.write( formatLegacyConfig( samplingValues[1] + "_pixels", "sample range") ); w.newLine();
        }
        
        w.write( formatFloatLegacyConfig(t.get("posAngle"), "position angle") ); w.newLine();
        ...
        w.write( formatLegacyConfig( filter, "filter" ) );  w.newLine();
        ...
        w.write( formatLegacyConfig( slitWidth, "slit width" ) ); w.newLine();
        ...
        w.write( formatLegacyConfig( disperser, "grating" ) ); w.newLine();

        w.write( formatFloatLegacyConfig( t.get("centralWavelength"), "wavelength") ); w.newLine();
        w.write( formatLegacyConfig( t.get("order"), "order" ) ); w.newLine();
        ...
        w.write( formatLegacyConfig( offset.toString(), "cvf offset" )  ); w.newLine();

        w.write( formatLegacyConfig(t.get("calibLamp"), "calibration lamp") ); w.newLine();
        w.write( formatLegacyConfig(t.get("tunHalLevel"), "tungsten-halogen level") ); w.newLine();
        w.write( formatLegacyConfig(t.get("lampEffAp"), "Lamp effective aperture") ); w.newLine();

        w.write(" Flat configuration variant (from object): "); w.newLine();
        w.write( formatLegacyConfig(t.get("flatSampling"), "Flat sampling") ); w.newLine();
        ...
        w.write( formatFloatLegacyConfig(t.get("flatExpTime"),  "flat exposure time") ); w.newLine();
        w.write( formatIntLegacyConfig(t.get("flatNumExp"), "flat exposures/integ") ); w.newLine();
        w.write( formatIntLegacyConfig(t.get("flatSavedInt"), "flat integrations") ); w.newLine();

        w.write(" Dark configuration variant (from object): "); w.newLine();
        w.write( formatIntLegacyConfig(t.get("darkNumExp"), "dark exposure/integ") ); w.newLine();
        w.write( formatIntLegacyConfig(t.get("darkSavedInt"), "dark integrations") ); w.newLine();

        w.write(" Bias configuration variant (from object): "); w.newLine();
        w.write( formatFloatLegacyConfig(t.get("biasExpTime"),  "bias exposure time") ); w.newLine();
        w.write( formatIntLegacyConfig(t.get("biasNumExp"), "bias exposures/integ") ); w.newLine();
        w.write( formatIntLegacyConfig(t.get("biasSavedInt"), "bias integrations") ); w.newLine();

        w.write(" Arc configuration variant (from object): "); w.newLine();
        w.write( formatLegacyConfig(t.get("arcCalLamp"), "calibration lamp") ); w.newLine();
        ...
        w.write( formatLegacyConfig(filter, "filter") ); w.newLine();
        w.write( formatLegacyConfig(t.get("arcCvfWavelength"), "cvf wavelength") ); w.newLine();
        ...
        w.write( formatLegacyConfig(readMode, "acquisition configuration") ); w.newLine();
        w.write( formatFloatLegacyConfig(t.get("arcExpTime"),  "arc exposure time") ); w.newLine();
        w.write( formatIntLegacyConfig(t.get("arcNumExp"), "arc exposures/integ") ); w.newLine();
        w.write( formatIntLegacyConfig(t.get("arcSavedInt"), "arc integrations") ); w.newLine();
    ...
    private String formatFloatLegacyConfig( Object o, String comment ) 
    ...
    private String formatIntLegacyConfig( Object o, String comment )
        throws NumberFormatException {
